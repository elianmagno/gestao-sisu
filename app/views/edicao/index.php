<?php $pageTitle = 'Edições - SISU';
$activeNav = 'edicao'; ?>
<?php include __DIR__ . '/../partials/header.php'; ?>

<nav class="text-sm text-gray-500 mb-6">
    <span>Início</span> <span class="mx-2">/</span>
    <span class="text-gov-blue font-medium">Edições</span>
</nav>

<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gov-blue-dark">Edições</h1>
        <p class="text-gray-500 text-sm mt-1">Gerencie as edições do SISU</p>
    </div>
    <a href="/edicao/create"
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gov-blue text-white text-left">
                    <th class="px-4 py-3 font-medium">Nome da Edição</th>
                ...
                <tr class="hover:bg-blue-50/50 transition-colors">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center justify-center gap-1">
                            <a href="/edicao/show?id=<?= $edition->id ?>"
                            ...
                            <a href="/edicao/destroy?id=<?= $edition->id ?>"
