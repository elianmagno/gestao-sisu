...
Simulação acadêmica do sistema de gerenciamento do **SISU** (Sistema de Seleção Unificada), construída como um **miniframework MVC** do zero — sem utilizar frameworks prontos — para aprofundar o entendimento sobre como frameworks web são estruturados internamente. Inclui CRUD completo de candidatos, cursos e edições, além de geração de listas de convocação com distribuição por cotas.
...
O projeto foi desenvolvido como um **miniframework MVC próprio**, sem utilizar nenhum framework pronto, com o objetivo de aprender na prática como frameworks web são construídos — desde o roteamento por URL até o ciclo de vida da request. A única dependência externa é o Eloquent ORM do Laravel para interação com o banco de dados:
...
|                  |                                                                                |
| ---------------- | ------------------------------------------------------------------------------ |
| **Idealizador**  | Prof. Me. Alessandro Rodrigues e Silva                                         |
| **Instituição**  | Instituto Federal de Educação, Ciência e Tecnologia de Goiás — Campus Anápolis |
| **Departamento** | Departamento de Áreas Acadêmicas                                               |
| **Curso**        | Bacharelado em Ciência da Computação                                           |
| **Disciplina**   | Programação Web                                                                |

O projeto foi proposto como atividade prática da disciplina de Programação Web, com o objetivo de construir um **miniframework MVC do zero**, sem utilizar frameworks prontos, proporcionando aos alunos uma compreensão aprofundada sobre como frameworks web são estruturados — abordando conceitos como roteamento, controllers, validação de requests, camada de serviço e integração com ORM.
